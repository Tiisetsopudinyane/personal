document.addEventListener("alpine:init",()=>{
    Alpine.data('data',()=>{
        return {
            ...
            aboutMe_p3:"Individually I am a very proactive person, person of multiple solutions to one problem, very analytical when it comes to assessing risks before applying the solution. I have a good communication skills and good reputation when working in collaboration and as a team member, I am an outspoken person with a good critical thinking skill and always aiming for good results.",
            sacArrayList:[],
            contacts(){
